...
# Module-level tracer, created once rather than per MacroGenerator instance
# (MacroGenerator is constructed on every macro call). It is inert (creates no
# spans) until the --snowflake-projects-otel gate opens a span in __call__.
